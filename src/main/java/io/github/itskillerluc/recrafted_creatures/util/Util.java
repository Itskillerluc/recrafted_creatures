...
import io.github.itskillerluc.recrafted_creatures.client.models.IAnimatableModel;
...
public class Util {
    ...
    public static void animate(IAnimatableModel pModel, AnimationDefinition pAnimationDefinition, long pAccumulatedTime, float pScale, Vector3f pAnimationVecCache) {
